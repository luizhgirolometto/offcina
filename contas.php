...
<head>
    ...
    <title>GiroMecânicas; | Principal </title>
                ...
                <!--div class="col-lg-12"-->
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                             <h3> Gerenciamento de contas a pagar/receber </h3>   
                         </div>
                        <div class="panel-body">

                        <div class="ibox-content">
                            <div class="pull-left">
                                <a onclick="#" href="contasi.php" class="btn btn-warning ">Incluir Conta</a>
                            </div>
                            <br>
                            <br>
                            <br>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    ...
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Contas a pagar/receber'},
                    {extend: 'pdf', title: 'Contas a pagar/receber'},
