<?php
    ...
    $aForn= ConsultarDados("", "", "","select * from fornecedores where codempresa = "."'{$codempresa}'"." left(flativ,1) = 'S' order by cdforn");
                ...
                <!--div class="col-lg-12"-->
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                             <h3> Cadastros de Fornecedores </h3>   
                         </div>
                        <div class="panel-body">

                        <div class="ibox-content">
                            <div class="pull-left">
                                <a onclick="#" href="fornecedoresi.php" class="btn btn-warning ">Incluir novo fornecedor</a>
                            </div>
                            <br>
                            <br>
                            <br>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    ...
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Relatório de Fornecedores'},
                    {extend: 'pdf', title: 'Relatório de Fornecedores'},
